...
3. Register the program name in the dispatch table in `c++/pptool.cc`.

4. If the command should be callable as its own shell name, add it to the `SYMLINKS` list in `c++/Makefile`.

5. Add or update tests.

6. Add the command doc page and link it from `docs/mkdocs.yml`.
