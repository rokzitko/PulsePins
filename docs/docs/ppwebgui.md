...
* Timeline Composer: a dependency-free browser-side editor for simple multi-channel pulse timelines in raw cycles or absolute time units, with JSON draft import/export
