...
[Pmod DA3](https://digilent.com/shop/pmod-da3-one-16-bit-d-a-output/) SPI sweep. This generates DAC codes for a Pmod DA3 module using the C++ [SPI sequence generator](cpp.md#spi-sequence-generation) and streams them through PulsePins.
