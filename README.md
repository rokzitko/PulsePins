...
* KiCad schematics and layouts for interface cards that provide easy interfacing (PMOD, SMA), two buffered PP_PMOD SMA outputs for Q0 and Q1, ESD protection, status LEDs, external clock input with threshold control, and pads for CMOS crystal oscillators.
