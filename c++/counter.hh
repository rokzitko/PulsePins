...
public:
  ...
  counter(FPGA &_fpga,
    ...
    fpga(_fpga),
    dev(fpga.dev_h2f),
    linstr(dev, base.base, 1*4, name + "/instr"),
    lpart(dev, base.base, 2*4, name + "/part"),
    laddr(dev, base.base, 3*4, name + "/addr"),
    lsel0(dev, base.base, 4*4, name + "/sel0"),
    lsel1(dev, base.base, 5*4, name + "/sel1"),
    lsel2(dev, base.base, 6*4, name + "/sel2"),
    lctrl(dev, base.base, 7*4, name + "/ctrl"),
    lresult(dev, base.base, 0*4, name + "/result"),
    loverflow_bc(dev, base.base, 1*4, name + "/overflow_bc"),
    loverflow_pc(dev, base.base, 2*4, name + "/overflow_pc"),
    ltcready(dev, base.base, 3*4, name + "/tcready"),
