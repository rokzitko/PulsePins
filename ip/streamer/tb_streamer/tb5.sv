...
always @(posedge clk) begin
  $strobe("t=%8.3f q_p=%b q_m=%b used=%d fifo_empty=%b state=%d armed=%b activated=%b used_o=%d done=%b retrig_req=%b qout=%h valid=%b",
    $realtime,
    dut.ct0.q_pattern, dut.ct0.q_mask, dut.ct0.used, dut.ct0.fifo_empty, dut.ct0.state,
    dut.trigger_armed, dut.trigger_activated, dut.used_o, dut.done, dut.retrig_requested,
