...
streamer dut(.clk, .reset, .input_data, .input_valid, .input_ready, .initial_value, .initial_reload(1'b0), .initial_value_streamer(initial_value), .trigger_enable, .trigger_force,
