...
// Purpose: additional sequence-histogram counter scenario.
//
// Extends coverage of the bit-pattern histogram logic beyond the primary directed case.
...
initial begin
  ...
  check(3'b101, 3);
  check(3'b110, 2);
  check(3'b111, 3); // sum=22=24-(length-1)
  $display("series 1 ok");
